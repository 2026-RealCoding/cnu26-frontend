...
export default function App() {
  ...
  // ============================================================
  // TODO: const { ... } = useCart();
  const {cart, addToCart, totalCount, totalPrice, removeFromCart, updateQuantity, clearCart} = useCart();
  // 장바구니 열림/닫힘 상태
    ...
    <div className="app">
      ...
      <main className="main">
        {isLoggedIn ? (
          ...
          // ============================================================
          <ProductList /* TODO: onAddToCart 전달 */onAddToCart={addToCart} />
        ) : (
